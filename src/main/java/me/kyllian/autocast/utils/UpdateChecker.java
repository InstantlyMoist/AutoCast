...
public class UpdateChecker {
    ...
    public UpdateChecker(AutoCastPlugin plugin, int project) {
        this.plugin = plugin;
    ...
    public String getUpdateMessage() {
        if (update) return plugin.getFileHandler().getUpdateFoundMessage(version, newVersion);
        else return plugin.getFileHandler().getUpdateNotFoundMessage();
    }
}
